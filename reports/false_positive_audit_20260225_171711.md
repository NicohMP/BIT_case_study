...
- (0.700) `1058198` — USDTb depeg by December 31?
  - event: Stablecoins depeg before 2027?
  - matched_terms: `["anchor:stablecoins", "stablecoins"]`
- (0.700) `1058197` — PYUSD depeg by December 31?
  - event: Stablecoins depeg before 2027?
  - matched_terms: `["anchor:stablecoins", "stablecoins"]`
...
- (sim=0.404, rule=0.000) `1163699` — Clarity Act signed into law in 2026?
  ...
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.393, rule=0.000) `920297` — Will Company F have the best AI model for coding on March 31?
  - event: Which company will have the best AI model for coding on March 31?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `["best ai model"]`
...
- (sim=0.352, rule=0.000) `909467` — SpaceX IPO closing market cap above $1.4T?
  ...
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.344, rule=0.000) `676787` — Rippling IPO before 2027?
  - event: IPOs before 2027?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
...
### Borderline discovery (high similarity, rejected by rules)
- (sim=0.354, rule=0.000) `549618` — Will Pump.fun perform an airdrop by July 31?
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.351, rule=0.000) `561700` — Will Pump.fun perform an airdrop by August 31?
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.342, rule=0.000) `567468` — Will Pump.fun perform an airdrop by September 30?
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.342, rule=0.000) `567469` — Will Pump.fun perform an airdrop by December 31?
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.339, rule=0.000) `561699` — Will Pump.fun perform an airdrop by July 18?
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.338, rule=0.000) `549617` — Will Pump.fun perform an airdrop by June 30?
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.338, rule=0.000) `1021180` — Will Bank Q or any of its underwriting affiliates serve as the lead underwriter in SpaceX’s initial public offering?
  - event: Lead Bank in SpaceX’s IPO?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.338, rule=0.000) `1323325` — Will the US federal government take a stake in IonQ, Inc.?
  - event: Which companies will the US take a stake in?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.337, rule=0.000) `1068327` — Will Pump.fun perform an airdrop by December 31, 2026
  - event: Pump.fun airdrop by ....?
  - anchors_hit: `[]`
  - keyword_hits: `[]`
  - exclusions_hit: `[]`
- (sim=0.337, rule=0.000) `995773` — SpaceX goes public through Bill Ackman "SPAR" company?
