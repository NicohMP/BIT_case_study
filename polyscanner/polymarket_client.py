...
This module intentionally does NOT write to the database yet. For the case study
wire-up, it's enough to ingest into memory and pass through the pipeline.
"""
...
def fetch_active_markets(
    *,
    ...
    Gamma fields can change over time; we keep `raw` in `PMMarket` for safety.
    """
